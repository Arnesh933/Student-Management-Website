...
<option VALUE="">SELECT</option>
 ...
 <input class="form-control" name="c-full"  id="c-full" >
	 ...
	 <br><br>								
		...
		<select class="form-control" name="session" id="session"  onchange="showSub(this.value)" required="required" >			
<option VALUE="">SELECT</option>
				<?php while($res=$ses->fetch_object()){?>							
			
                        <option VALUE="<?php echo htmlentities($res->session);?>"><?php echo htmlentities($res->session)?></option>
